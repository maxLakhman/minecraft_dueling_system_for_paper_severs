...
public class DuelManager {
    ...
    public void sendDuelRequest(Player sender, Player target) {
        ...
        //Component clickableMessageAccept = Component.text(" [Accept] ").color(NamedTextColor.BLUE).clickEvent(ClickEvent.("/duel accept")); this would mess things up. /duel accept just accepts the most recent. They'd want to accept the specific one they were sent. So that would need arguments
        //target.sendMessage(clickableMessageAccept);
        //Component clickableMessageReject = Component.text("Reject").clickEvent(ClickEvent.runCommand("/duel accept")); //reject should get rid of it
    ...
    public void acceptDuelRequest(Player acceptor){
        ...
        if (originalSender != null && originalSender.isOnline() && acceptor!= null && acceptor.isOnline()){
            ...
            saveInventories(originalSender, acceptor);
    ...
    public void saveInventories(Player originalSender, Player acceptor){
